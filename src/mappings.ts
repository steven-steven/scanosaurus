...
export const componentMap = {
  ...
  NtMergetag: dynamic(() =>
    import('@src/components/features/ctf-components/ctf-pricing/ctf-pricing').then(
      module => module.CtfPricing,
    ),
  ),
};
...
export const componentGqlMap = {
  ...
  NtMergetag: dynamic(() =>
    import('@src/components/features/ctf-components/ctf-pricing/ctf-pricing-gql').then(
      module => module.CtfPricingGql,
    ),
  ),
